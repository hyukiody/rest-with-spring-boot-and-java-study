package br.com.somestudy.security.jwt;
...
import br.com.somestudy.data.dto.security.TokenDTO;
import br.com.somestudy.exception.InvalidJwtAuthenticationException;
...
public class JwtTokenProvider {
	...
	private String getRefreshToken(String username, List<String> roles, Date now) {
		...
		return JWT.create().withClaim("roles", roles).withIssuedAt(now)
				.withExpiresAt(refreshTokenValidity).withSubject(username)
				.sign(algorithm);
	}
