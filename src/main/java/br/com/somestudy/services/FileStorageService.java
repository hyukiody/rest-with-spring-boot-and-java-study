...
import br.com.somestudy.config.FileStorageConfig;
import br.com.somestudy.exception.FileNotFoundException;
...
public class FileStorageService {
	...
	public FileStorageService(FileStorageConfig fileStorageConfig) {
		...
		try {
			...
			logger.error("Could not create the directory where files will be sotred!");
	...
	public Resource loadFileAsResource(String fileName) {
		try {
			...
			if(resource.exists()) {
				...
				logger.error("Filenot found " + fileName);
